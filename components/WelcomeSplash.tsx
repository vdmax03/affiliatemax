...
export const WelcomeSplash: React.FC = () => {
  return (
    <div className="text-center p-8">
      <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="p-4 bg-gray-700/30 rounded-lg border border-gray-600">
            ...
            <p className="text-sm text-gray-400">Upload your product photo to get started</p>
          </div>
          ...
          <div className="p-4 bg-gray-700/30 rounded-lg border border-gray-600">
            ...
            <p className="text-sm text-gray-400">AI creates prompts and generates video</p>
          </div>
          ...
          <div className="p-4 bg-gray-700/30 rounded-lg border border-gray-600">
            ...
            <p className="text-sm text-gray-400">Get your professional video ready for social media</p>
          </div>
        </div>

        <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-lg p-6 border border-indigo-500/30">
