...
export const WelcomeSplash: React.FC = () => {
  return (
    <div className="text-center p-8">
      <div className="rounded-xl bg-gray-800/40 border border-[#2a2f3a] p-8 max-w-4xl mx-auto">
        <div className="flex items-center justify-center gap-3 mb-6">
          <FilmIcon className="w-12 h-12 text-indigo-400" />
          <h2 className="text-3xl font-bold text-gray-100">Welcome to Virtual Affiliate Generator</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="p-4 bg-gray-800/30 rounded-lg border border-[#2a2f3a]">
